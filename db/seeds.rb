...
wookiemood = [
  ...
  7.times do |i|
    leia.posts.create(text: Faker::Movies::StarWars.quote(character: "leia_organa"), mood: mood[rand(5)])
  end
  ...
  4.times do |i|
    dv.posts.create(text: Faker::Movies::StarWars.quote(character: "anakin_skywalker"), mood: mood[rand(5)])
  end
  4.times do |i|
    dv.posts.create(text: Faker::Movies::StarWars.quote(character: "darth_vader"), mood: mood[rand(5)])
  end
  ...
  6.times do |i|
    kylo.posts.create(text: Faker::Movies::StarWars.quote(character: "kylo_ren"), mood: mood[rand(5)])
  end
  ...
  8.times do |i|
    han.posts.create(text: Faker::Movies::StarWars.quote(character: "han_solo"), mood: mood[rand(5)])
  end
  ...
  1.times do |i|
    thrawn.posts.create(text: Faker::Movies::StarWars.quote(character: "grand_admiral_thrawn"), mood: mood[rand(5)])
  end
  ...
  4.times do |i|
    yoda.posts.create(text: Faker::Movies::StarWars.quote(character: "yoda"), mood: mood[rand(5)])
  end
  ...
  4.times do |i|
    palp.posts.create(text: Faker::Movies::StarWars.quote(character: "emperor_palpatine"), mood: mood[rand(5)])
  end
  ...
  10.times do |i|
    luke.posts.create(text: Faker::Movies::StarWars.quote(character: "luke_skywalker"), mood: mood[rand(5)])
  end
  ...
  5.times do
    ahsoka.posts.create(text: Faker::Movies::StarWars.quote(character: "ahsoka_tano"), mood: mood[rand(5)])
  end
  ...
  3.times do
    tarkin.posts.create(text: Faker::Movies::StarWars.quote(character: "grand_moff_tarkin"), mood: mood[rand(5)])
  end
  ...
  22.times do |i|
    chewie.posts.create(text: Faker::Movies::StarWars.wookiee_sentence, mood: wookiemood[rand(5)])
  end
